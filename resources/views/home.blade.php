<x-layout>
                ...
                <div class="hero-wrapper-two">
                    <div class="hero-slider-two">
                        ...
                        <div class="single-slider">
                            <div class="image-layer bg_cover" style="background-image: url(assets/images/hero/hero-two_slider-1.jpg);"></div>
                            <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-12">
                            <div class="about-content-box mb-50">
                                ...
                                <p class="mb-40">Sit amet consectetur adipiscing elit. At donec et fusce orci tellus aliquam vitae. Metus nibh laoreet velit, diam enim. Justo
            ...
            <!--====== Start Video Section ======-->
            <section class="video-bg-section pt-140 pb-110 p-r z-1 bg_cover" style="background-image: url(assets/images/video/video-1.jpg);">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8">
